...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        Action act1 = new Action (1,"Twitter",134.15,159,110);
        Action act2 = new Action (2,"Apple",123.15,103,106);
        Action act3 = new Action (3,"Facebook",190.15,124,45);
        Action act4 = new Action (4,"Microsoft",68.15,80,34);
        Action act5 = new Action (5,"Dell",56.12,50,78);
        Action act6 = new Action (6,"VMWare",101.67,145,67);
        Action act7 = new Action (7,"IBM",40,27,89);
    ...
    private void tblTradersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTradersMouseClicked
     ...
     double montantTotal = 0;
       for(Trader trad : mesTraders)
       {
           if(trad.getIdTrader() == numTrader)
           {
               for(Action act : trad.getMesActions())
               {
                   ...
                   montantTotal = ( act.getValeurAction()*act.getQuantiteAction() - act.getPrixAction()*act.getQuantiteAction());
       ...
       lblPortefeuille.setText(String.valueOf(montantTotal));
    ...
    private void tblActionsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblActionsMouseClicked
       ...
       for(Trader trad : mesTraders)
       {
          ...
          for(Action act : trad.getMesActions())
          {
              ...
              {
                 if(act.getValeurAction()>act.getPrixAction())
                 {
                     JOptionPane.showMessageDialog(this,"Vous gagnez de l'argent sur cette action");
                 }
                 else
                 {
                      JOptionPane.showMessageDialog(this,"Vous avez perdu de l'argent sur cette action");
                 }
                }
          }
       }
        
       lblMessage.setText(String.valueOf(this));
